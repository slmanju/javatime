...
public class ListRecords extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<RecordsEntity> entities = recordsEntityFacade.findAll();
            entities.forEach(entity -> {
                out.println("<b>" + entity.getRecordName() + "</br>");
                out.println("<br/>");
                out.println(entity.getArtistName());
                out.println("<br/>");
            });
            out.println("<a href='PostRecord'>Add a record</a>");
            out.println("<br/>");
            out.println("<br/>");
            out.println(sessionManagerBean.getActiveSessionsCount() + " users conntected");
            out.println("<h1>Servlet ListRecords at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
